let Joi,likeSign,mongoose;_52b‍.x([["checkObjectId",()=>checkObjectId],["LikeAndSign",()=>LikeAndSign],["check",()=>check],["list",()=>list],["remove",()=>remove],["read",()=>read]]);_52b‍.w("@hapi/joi",[["default",["Joi"],function(v){Joi=v}]]);_52b‍.w("../../models/likeSign",[["default",["likeSign"],function(v){likeSign=v}]]);_52b‍.w("mongoose",[["default",["mongoose"],function(v){mongoose=v}]]);
...
const { ObjectId } = mongoose.Types;
    ...
    _52b‍.g.console.log("ls_type : " + ls_type)
    _52b‍.g.console.log(ls_myid)
    _52b‍.g.console.log("ls_productcode : " + ls_productcode)
    try{
    ...
    _52b‍.g.console.log(ls_type + ', ' + ls_myid + ", " + ls_productcode + "옴??");
    try{
