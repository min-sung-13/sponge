let Joi,ProjectAndClass;_259‍.x([["checkOwnProject",()=>checkOwnProject],["write",()=>write],["list",()=>list],["listByHit",()=>listByHit],["listByNew",()=>listByNew],["listBySuc",()=>listBySuc],["listByJu",()=>listByJu],["read",()=>read],["update",()=>update],["update2",()=>update2],["read2",()=>read2],["remove",()=>remove],["check",()=>check],["check2",()=>check2],["pick",()=>pick],["pick2",()=>pick2]]);_259‍.w("@hapi/joi",[["default",["Joi"],function(v){Joi=v}]]);_259‍.w("../../models/ProjectAndClass",[["default",["ProjectAndClass"],function(v){ProjectAndClass=v}]]);


       const checkOwnProject = (ctx, next)=>{
    ...
    if(result.error){
        _259‍.g.console.log(result.error);
        ctx.status = 400;
    ...
    try{
       ...
       const listBySuc = async (ctx) => {

    var tdate = new Date();
    _259‍.g.console.log(tdate);
