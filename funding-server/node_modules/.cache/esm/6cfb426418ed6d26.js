let Joi,Coupon;_18e‍.x([["defaultCoupon",()=>defaultCoupon],["selectUser",()=>selectUser],["couponList",()=>couponList]]);_18e‍.w("@hapi/joi",[["default",["Joi"],function(v){Joi=v}]]);_18e‍.w("../../models/coupon",[["default",["Coupon"],function(v){Coupon=v}]]);


       const defaultCoupon = async (ctx) => {
    // 초기 쿠폰 설정
    ...
    try {
        ...
        _18e‍.g.console.log(users);
    } catch (e) {
        ctx.throw(500, e);
    }
};

       const couponList = async (ctx) => {
    // 전체 포인트 리스트
