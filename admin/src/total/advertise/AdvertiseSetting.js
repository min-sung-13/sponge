...
import AdvertiseListContainer from '../../containers/advertise/AdvertiseListContainer';
...
class AdvertiseSetting extends Component {
      ...
      <nav className="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div className="container-fluid">
          <div className="navbar-wrapper">
            ...
            <a className="navbar-brand" href="javascript:;">광고 관리</a>
          </div>
