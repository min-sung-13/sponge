      ...
      <body class="">
        <div className="wrapper ">
          <div className="sidebar" data-color="white" data-active-color="danger">
            <div className="logo">
              <a href="https://www.creative-tim.com" className="simple-text logo-mini"></a>
            ...
            <div className="col-md-12">
              <div className="card card-plain">
                <div className="card-header">
                  <h4 className="card-title">공지사항 관리</h4>
                  <p className="card-category">공지사항 목록</p>
                </div>
                <div>
                  <button className="btn_notice">공지 등록</button>
                </div>
                <NoticeListContainer />
              </div>
            </div>
